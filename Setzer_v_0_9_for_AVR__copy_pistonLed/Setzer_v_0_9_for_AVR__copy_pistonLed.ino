// wer. 0.8.1 sterowanie SET komuniakatem MIDI i uruchomieniw na Atmega644P - dodane Ceresc ale nie sprawdzone.
// Tested for Atmega32A - Bobuino Pin - - - chipSelect = 10; - Encoder encoder(2,3);
// and Atmega644P - Standard Pin - - - cc - Encoder encoder(10,11);
// and Atmega1284 - Bobuino Pin - - - chipSelect = 10; - Encoder encoder(2,3);
// wer. 0.9 dodano sterowanie podswietleniem pistons 
// for arduino MEGA chipselect = 53
...
Encoder encoder(10,11); // Podłącz enkoder do pinów 2 i 3 w UNO and Atmega32A -Bobuinopin // Mega, mega2560 pro andAtmega644P - standard pin do pin 10 i 11
...
//**************KONIEC sekcji z nacisnietym przyciskiem SET*****************
  ...
  if (pitch == 76){
    ...
    nr = 1;
    readToSDCard();
    MIDI.sendNoteOn (76, 127, 13);
  }
   if (pitch == 77){
    digitalWrite(CrescendoPin, HIGH); // Anulowanie działania crescendo (A)
    nr = 2;
    readToSDCard();
    MIDI.sendNoteOn (77, 127, 13);
